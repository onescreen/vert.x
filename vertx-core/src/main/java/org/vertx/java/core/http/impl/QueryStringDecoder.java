...
/* Pulled from github.com:netty/netty, src/main/java/org/jboss/netty/handler/codec/http/QueryStringDecoder.java,
 * commit 611269c0f0653efc0447b4a7b6511ef77955afe8 (tag: 3.9.5-final) 
 * The goal is to have a decoder that is more friendly to parameters that are incorrectly URL-encoded - 
 * instead of throwing an exception, this decoder will merely prefix the key with "bad_encoding-" and 
 * leave the key/value in the url-encoded state. */
